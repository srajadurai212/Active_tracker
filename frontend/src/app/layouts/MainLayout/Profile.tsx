              ...
              <>
                ...
                <div className="flex items-center gap-4 rounded-t-lg bg-gray-100 px-4 py-5 dark:bg-dark-800">
                  ...
                  <div>
                    ...
                    <p className="mt-0.5 text-xs capitalize text-gray-400 dark:text-dark-300">
                      {user?.role ?? "user"}
                    </p>
                  </div>
                </div>
                ...
                <div className="flex flex-col pb-5 pt-2">
                  ...
                  <button
                    ...
                    className="group flex items-center gap-3 px-4 py-2 tracking-wide outline-hidden transition-all hover:bg-gray-100 focus:bg-gray-100 dark:hover:bg-dark-600 dark:focus:bg-dark-600 w-full text-left"
                  >
                    <Avatar
                      size={8}
